...
public function previous_transfor(){
 ...
 public function remove_prepaid_deposit($dep_id){
    ...
    $first_name =$new_pending->f_name;
    $middle_name =$new_pending ->m_name;
    $last_name = $new_pending ->l_name;
    $phone = $new_pending->phone_no;
...
public function sendsms($phone,$massage){
  ...
  $token = "35|CNtHkOWFsXAQIqdYdziQpQDpnzPxVCGp9zJ3Yq3O60625a04";
