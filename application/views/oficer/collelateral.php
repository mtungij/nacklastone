...
<?php include('incs/side.php'); ?>
    ...
    <label for="co_condition">Hali ya Dhamana:</label>
    <select class="form-control" id="co_condition" name="co_condition" required>
        <option value="">Chagua Hali</option>
        <option value="new">Mpya</option>
        <option value="used">Imetumika kiasi</option>
