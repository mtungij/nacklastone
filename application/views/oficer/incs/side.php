                ...
                <div class="tab-pane" id="sub_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li>
                                <a href="#Widgets" class="has-arrow"><i class="icon-list"></i><span>Payment Report</span></a>
                                <ul>
                                    <li><a href="<?php echo base_url("oficer/cash_transaction"); ?>">General Transaction</a></li>
                                    <!-- <li><a href="</?php echo base_url("oficer/mobile_payment"); ?>">Mobile Payment</a></li> -->
                                    
                                    <li><a href="<?php echo base_url("oficer/penalt_today"); ?>">Penalt Payment</a></li>
                                    <li><a href="<?php echo base_url("oficer/transanction_oficer"); ?>">Teller Officer Payment</a></li>
